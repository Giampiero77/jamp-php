<?php
	...
	define("COMPRESSJS", false);	// Compress javascript
	define("NOCACHEPHP", true);	// true - No cache php, false - Browser/Proxy setting
	define("NOCACHEJS", "17092011");	// time(): No cache javascript, <constant>(es. 0505023232), false: Browser/Proxy setting
	define("NOCACHECSS", "17092011");	// time(): No chache CSS, <constant>(es. 0505023232), false: Browser/Proxy setting
