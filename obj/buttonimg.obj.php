...
class ClsObj_buttonimg extends ClsObject {
	...
	*/
	public function __construct($id) 
	{
		...
		$this->property["value"] 	  	= array("value" => "button",  "inherit" => false, "html" => false);
	...
	*/
	...
	{
		$code = "\n$tab<button ".$this->getProperty("html", true, false);
		if ($this->property["disabled"]["value"] == "true") $code.=" disabled";
		$code .='><img align="left" style="vertical-align: middle;" src="'.$this->property["src"]["value"].'">';
		$code .= "<div style=\"padding-top:7px\">".$this->property["value"]["value"]."</div>";
		$code .="</button>";
