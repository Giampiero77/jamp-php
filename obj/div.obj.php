...
class ClsObj_div extends ClsObject {
	/**
	...
	*/
	public function __construct($id)	
	{
		...
		$this->property["drag"]		= array("value" => null, "inherit" => true,  "html" => false);
	...
	*/
	...
	{
		if  ($this->property["drag"]["value"]=="true")	
		{
			$this->property["java"]["value"] = "drag.js";
			$this->setCodeJs("\t\tDRAG.init(\"".$this->property["id"]["value"]."\");");
		}
