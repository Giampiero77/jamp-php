...
class ClsObj_dsselecturl extends ClsObject {
	/**
	* Construct
	...
	*/
	public function __construct($id)
	{
		...
		$this->property["outlabel"]		= array("value" => null, "inherit" => false, "html" => false);
		...
		$this->property["height"]	  	= array("value" => null,  "inherit" => false, "html" => false);
 		$this->property["java"]  		= array("value" => array("dsselecturl.js", "format.js"), "inherit" => false, "html" => false);
	...
	*/
	public function codeHTML($tab = "")
	{
		...
		if ($this->property["outlabel"]["value"] == "label" || $this->property["outlabel"]["value"] == "url") $this->property["style"]["value"] .= "display:none;";
		...
		$code .= "\n$tab</select>";
		if ($this->property["outlabel"]["value"] == "label" || $this->property["outlabel"]["value"] == "url") $code .= "<span name=\"DSSELECTURL_label\"></span>";
	...
	*/
	public function BuildObj()	
	{
		...
		if($this->property["outlabel"]["value"] == "url")
		{
			$this->propertyJS["target"]= $this->property["target"]["value"];
		...
		if (!empty($this->property["dsobjlist"]["value"]))
		{
			...
			$this->addEvent($id, $dsobjlist."Refresh", "DSSELECTURL.refreshObj(\"$id\");");
		}
		if (!empty($this->property["dsobj"]["value"]))
		{
			$dsobj = $this->property["dsobj"]["value"];
			$this->propertyJS["dsObj"] = $dsobj;
			$this->addEvent($id, $dsobj."Move", "DSSELECTURL.getDsValue(\"$id\");");
			$this->addEvent($id, $dsobj."Refresh", "DSSELECTURL.getDsValue(\"$id\");");
		}
		...
		$this->property["onchange"]["value"] = "DSSELECTURL.change(this); ".$this->property["onchange"]["value"];
	}
	...
	*/
	protected function setPropertyAfter($name)
	{
		...
		switch($name)
		{
			...
			case "outlabel":
				if ($this->property["outlabel"]["value"] == "label") $this->propertyJS["outlabel"] = "label";
				if ($this->property["outlabel"]["value"] == "url")
				{
					$this->propertyJS["outlabel"] = "url";
					$this->propertyJS["target"]= $this->property["target"]["value"];
					$this->propertyJS["action"] = $this->property["action"]["value"];
					$this->propertyJS["actionparam"] = $this->property["actionparam"]["value"];
				}
	...
	*/
	public function refreshOBJ()
	{
		...
		{
			$js = "DSSELECTURL.refreshObj(\"".$this->property["id"]["value"]."\");";
		}
		return $js;
	}
}
