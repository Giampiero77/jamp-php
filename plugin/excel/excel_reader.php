...
class Spreadsheet_Excel_Reader {
	...
	function hyperlink($row,$col,$sheet=0) {
		if (isset($this->sheets[$sheet]['cellsInfo'][$row][$col]['hyperlink'])) return $this->sheets[$sheet]['cellsInfo'][$row][$col]['hyperlink'];
		return '';
	}
	...
	function colwidth($col,$sheet=0) {
		...
		if (isset($this->colInfo[$sheet][$col]['width'])) return $this->colInfo[$sheet][$col]['width']/9142*200;
		return 0;
	}
	function colhidden($col,$sheet=0) {
		if (isset($this->colInfo[$sheet][$col]['hidden'])) return !!$this->colInfo[$sheet][$col]['hidden'];
		return 0;
	}
	function rowheight($row,$sheet=0) {
		if (isset($this->rowInfo[$sheet][$row]['height'])) return $this->rowInfo[$sheet][$row]['height'];
		return 0;
	}
	function rowhidden($row,$sheet=0) {
		if (isset($this->rowInfo[$sheet][$row]['hidden'])) return !!$this->rowInfo[$sheet][$row]['hidden'];
		return 0;
	}
	...
	function borderLeftColor($row,$col,$sheet=0) {
		if (isset($this->colors[$this->xfProperty($row,$col,$sheet,'borderLeftColor')])) return $this->colors[$this->xfProperty($row,$col,$sheet,'borderLeftColor')];
	}
	function borderRightColor($row,$col,$sheet=0) {
		if (isset($this->colors[$this->xfProperty($row,$col,$sheet,'borderRightColor')])) return $this->colors[$this->xfProperty($row,$col,$sheet,'borderRightColor')];
	}
	function borderTopColor($row,$col,$sheet=0) {
		if (isset($this->colors[$this->xfProperty($row,$col,$sheet,'borderTopColor')])) return $this->colors[$this->xfProperty($row,$col,$sheet,'borderTopColor')];
	}
	function borderBottomColor($row,$col,$sheet=0) {
		if (isset($this->colors[$this->xfProperty($row,$col,$sheet,'borderBottomColor')])) return $this->colors[$this->xfProperty($row,$col,$sheet,'borderBottomColor')];
	}
